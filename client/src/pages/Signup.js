...
const Signup = () => {
  return (
    ...
    <div className='h-[500px] md:h-[600px] flex flex-col items-center justify-evenly w-[350px] md:w-[500px] outline outline-1 outline-gray-300 dark:outline-gray-700 rounded-xl mt-6'>
  ...
  <div className='text-gray-400 flex justify-center'>
          Already Have an Account ? <Link className='text-orange-400' to='/'>&nbsp;Signup</Link>
    </div>
    </div>
